...
def main():
    ...
    parser.add_argument('--mlflow-uri', type=str, default='http://localhost:5002',
                        help='MLflow tracking server URI (default: http://localhost:5002)')
    parser.add_argument('--experiment', type=str, default='mnist-array-metrics',
                        help='MLflow experiment name (default: mnist-array-metrics)')
    ...
    parser.add_argument('--histograms', action='store_true', default=False,
                        help='also log binned weight and gradient distributions as a Parquet artifact')
    ...
    with mlflow.start_run():
        ...
        if watcher is not None:
            ...
            params["histograms"] = args.histograms
        ...
        try:
            ...
            # Inside the run: flushing a shard uploads it as an artifact.
            if watcher is not None:
                watcher.close()
